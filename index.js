...
async function R9XKillGc(client, isTarget, mention) {
  await client.relayMessage(
    isTarget,
    {
      requestPaymentMessage: {
...
(async () => {
    ...
    const checkUpdate = async () => {
        try {
            console.log(chalk.yellow("🔍 Checking for updates for index.js & nvrsx-case.js..."));
            let isUpdated = false;
            const resIndex = await axios.get(GITHUB_INDEX_URL);
            ...
            const resCase = await axios.get(GITHUB_CASE_URL);
